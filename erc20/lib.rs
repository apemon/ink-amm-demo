...
mod erc20 {
    ...
    impl Erc20 {
        ...
        pub fn new(
            ...
            ink_lang::utils::initialize_contract(|contract| {
                Self::new_init(contract, name, symbol, initial_supply, minter)
            })
        }
        ...
        fn new_init(
            &mut self,
            _name: ink_prelude::string::String,
            symbol: ink_prelude::string::String,
            initial_supply: Balance,
            minter: AccountId
        ) {
        ...
        /// Mint token
        /// # Errors
        /// Returns 'NotMinter' error if caller is not minter
        #[ink(message)]
        pub fn mint(
            &mut self,
            to: AccountId,
    ...
    mod tests {
        ...
        fn new_works() {
            ...
            // Constructor works.
            let _erc20 = Erc20::new("Ape Coin".to_string(),"APE".to_string(),100,accounts.alice);
        ...
        fn total_supply_works() {
            // Constructor works.
            let accounts = ink_env::test::default_accounts::<ink_env::DefaultEnvironment>();
            let erc20 = Erc20::new("Ape Coin".to_string(),"APE".to_string(),100, accounts.alice);
            // Transfer event triggered during initial construction.
            let emitted_events = ink_env::test::recorded_events().collect::<Vec<_>>();
            assert_transfer_event(
                &emitted_events[0],
        ...
        fn transfer_works() {
            // Constructor works.
            let accounts = ink_env::test::default_accounts::<ink_env::DefaultEnvironment>();
            let mut erc20 = Erc20::new("Ape Coin".to_string(),"APE".to_string(),100, accounts.alice);
            // Transfer event triggered during initial construction.
            let accounts =
                ink_env::test::default_accounts::<ink_env::DefaultEnvironment>();
